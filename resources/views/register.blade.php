			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6">
		      	...
		      	<h3 class="text-center mb-0">Welcome</h3>
						<form action="{{route('post_register')}}" method="post" class="login-form">
						@csrf
						<div>
		      		...
		      		<div class="form-group">
						  ...
						  @if ($errors->any())
						  <p style="color:red">&emsp;{{ $errors->first('userName') }}</p>
						  @endif
		      		</div>
		      		<div class="form-group">
		      			<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-user"></span></div>
						  ...
						  @if ($errors->any())
						  <p style="color:red">&emsp;{{ $errors->first('email') }}</p>
						  @endif
		      		</div>
		      		<div class="form-group">
		      			<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-user"></span></div>
						  ...
						  @if ($errors->any())
						  <p style="color:red">&emsp;{{ $errors->first('phone') }}</p>
						  @endif
		      		</div>
		      		<div class="form-group">
		      			<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-user"></span></div>
						  ...
						  @if ($errors->any())
						  <p style="color:red">&emsp;{{ $errors->first('birthday') }}</p>
						  @endif
		      		</div>
	            <div class="form-group">
				  ...
				  @if ($errors->any())
				  <p style="color:red">&emsp;{{ $errors->first('password') }}</p>
				  @endif
	            </div>
	            <div class="form-group">
